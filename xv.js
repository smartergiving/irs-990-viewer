...
var xv_renderer = (function() {
	...
	function stylizeElement(node, depth) {
		var attrs = _.map(xv_utils.filterValidAttributes(node), function(n) {
			return '<span class="xv-attr" data-irs-key="' + n.name + '"><span class="xv-attr-name">' + n.name + '</span>' +
...
var xv_outline = (function(){
	...
	function stylizeElement(node, depth) {
		...
		result.push('<span class="xv-node xv-outline-node xv-outline-tag' + add_class + '" data-xv-id="' + xv_renderer.getId(node) + '" data-irs-key="' + node.nodeName +'">');
		result.push('<span class="xv-tag-switcher"></span>');
	...
	xv_signals.documentProcessed.addOnce(function() {
		...
		if (!pane) {
          ...
          '</div>' +
				  ...
				  '<span class="xv-outline-close">&#x276F</span>' +
...
/*
 * IRS Form 990PF Viewer
 * @author Chad Kruse (opensource@smartergiving.org)
 * @link https://smartergiving.org
 */
(function(){
